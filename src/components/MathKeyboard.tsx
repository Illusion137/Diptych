...
// FUNCTION_KEYS_GENERATED_START — regenerated by scripts/gen_interface_consts.ts
const FUNCTION_KEYS: Array<{ label: string; action: KeyAction }> = [
	...
	// Hyperbolic
	{ label: "sinh", action: { type: "write", latex: "\\sinh\\left(\\right)" } },
	{ label: "cosh", action: { type: "write", latex: "\\cosh\\left(\\right)" } },
	{ label: "tanh", action: { type: "write", latex: "\\tanh\\left(\\right)" } },
	{ label: "sech", action: { type: "write", latex: "\\operatorname{sech}\\left(\\right)" } },
	{ label: "csch", action: { type: "write", latex: "\\operatorname{csch}\\left(\\right)" } },
	{ label: "coth", action: { type: "write", latex: "\\operatorname{coth}\\left(\\right)" } },
	// Inverse Hyperbolic
	{ label: "arcsinh", action: { type: "write", latex: "\\operatorname{arcsinh}\\left(\\right)" } },
	{ label: "arccosh", action: { type: "write", latex: "\\operatorname{arccosh}\\left(\\right)" } },
	{ label: "arctanh", action: { type: "write", latex: "\\operatorname{arctanh}\\left(\\right)" } },
	// Logarithmic
	...
	// Statistical
	{ label: "mean", action: { type: "write", latex: "\\operatorname{mean}\\left(\\right)" } },
	{ label: "median", action: { type: "write", latex: "\\operatorname{median}\\left(\\right)" } },
	{ label: "std", action: { type: "write", latex: "\\operatorname{std}\\left(\\right)" } },
	{ label: "var", action: { type: "write", latex: "\\operatorname{var}\\left(\\right)" } },
	// Combinatorics
	...
	{ label: "clamp", action: { type: "write", latex: "\\operatorname{clamp}\\left(\\right)" } },
	{ label: "lerp", action: { type: "write", latex: "\\operatorname{lerp}\\left(\\right)" } },
	{ label: "norm", action: { type: "write", latex: "\\operatorname{norm}\\left(\\right)" } },
	{ label: "dot", action: { type: "write", latex: "\\operatorname{dot}\\left(\\right)" } },
	{ label: "cross", action: { type: "write", latex: "\\operatorname{cross}\\left(\\right)" } },
